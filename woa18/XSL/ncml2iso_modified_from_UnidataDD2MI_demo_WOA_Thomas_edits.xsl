...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:gmi="http://www.isotc211.org/2005/gmi"  xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gmx="http://www.isotc211.org/2005/gmx" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:date="http://exslt.org/dates-and-times" exclude-result-prefixes='date'>
	...
	<xsl:variable name="datasetname" select="'WOA18'"/>	
	<xsl:variable name="filesize" select="netcdf/filesize"/>
	<xsl:variable name="fileidentifier" select="netcdf/title"/>
	<xsl:variable name="browsegraphic" select="netcdf/browsegraphic"/>
...
<!-- Extent Search Fields: 17 possible -->
	...
	<xsl:variable name="geospatial_lat_min" select="//*[@name='geospatial_lat_min']/@value"/>
	<xsl:variable name="geospatial_lat_max" select="//*[@name='geospatial_lat_max']/@value"/>
	<xsl:variable name="geospatial_lon_min" select="//*[@name='geospatial_lon_min']/@value"/>
	<xsl:variable name="geospatial_lon_max" select="//*[@name='geospatial_lon_max']/@value"/>
	
	
	<xsl:variable name="timeStart" select="//*[@name='time_coverage_start']/@value"/>
	<xsl:variable name="timeEnd" select="//*[@name='time_coverage_end']/@value"/>
	...
	<xsl:template match="/">
		<gmi:MI_Metadata xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:gco="http://www.isotc211.org/2005/gco" xmlns:gmd="http://www.isotc211.org/2005/gmd" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:srv="http://www.isotc211.org/2005/srv" xmlns:gml="http://www.opengis.net/gml/3.2" xmlns:gsr="http://www.isotc211.org/2005/gsr" xmlns:gss="http://www.isotc211.org/2005/gss" xmlns:gts="http://www.isotc211.org/2005/gts" xmlns:gmi="http://www.isotc211.org/2005/gmi" xmlns:gmx="http://www.isotc211.org/2005/gmx" xsi:schemaLocation="http://www.isotc211.org/2005/gmi http://www.ngdc.noaa.gov/metadata/published/xsd/schema.xsd">
			...
			<gmd:parentIdentifier>
				...
				<gmx:Anchor xlink:href="http://data.nodc.noaa.gov/cgi-bin/iso?id=gov.noaa.nodc:0176314" xlink:actuate="onRequest">http://data.nodc.noaa.gov/cgi-bin/iso?id=gov.noaa.nodc:0176314</gmx:Anchor>
			</gmd:parentIdentifier>
			<gmd:hierarchyLevel>
										...
										<gmd:MD_DigitalTransferOptions>
											...
											<gmd:onLine>
												<gmd:CI_OnlineResource>
													...
													<gmd:description>
														<gco:CharacterString>This URL provides a standard HTTP interface for selecting data from this dataset. The transfer size is in mb.</gco:CharacterString>
													</gmd:description>
													<gmd:function>
	...
	<xsl:template name="writeVariableDimensions">
		...
		<gmd:dimension>
			<gmd:MD_Band>
				...
				<!-- <gmd:units>
					<xsl:attribute name="xlink:href"><xsl:value-of select="$variableUnits"/></xsl:attribute>
				</gmd:units> -->
			</gmd:MD_Band>
		</gmd:dimension>
	</xsl:template>
